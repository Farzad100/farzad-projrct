...
class Shop extends Model
{
    ...
    {
        return $this->hasMany(Doc::class, 'shop_id');
    }
    ...
    {
        return $this->hasMany(Order::class, 'shop_id')->inprogress();
    }

    public function orders_worthy()
    {
        return $this->hasMany(Order::class, 'shop_id')->worthy();
    }

    public function orders_worthless()
    {
        return $this->hasMany(Order::class, 'shop_id')->worthless();
    }
    ...
    public static function mobile($shop_id)
    {
        $shop = Shop::select('id', 'user_id')->whereId($shop_id)->with(['user' => function ($q) {
    ...
    {
        $x = Shop::select('name')->where('id', $id)->first();
        if (!$x) return '';
