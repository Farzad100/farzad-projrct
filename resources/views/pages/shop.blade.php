...
@php($title='قسطا | فروش اقساطی مخصوص فروشگاه ها')
@php($description='محصولات خود را قسطی بفروشید ولی هزینه آن را نقد دریافت کنید! اگه صاحب فروشگاه هستی با استفاده از خدمات قسطا ميتونی فروشت رو افزايش بدی.')
@php($url='https://ghesta.ir/shop')
...
<div class="header-style-2 mb-5 ">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6 col-lg-6 d-flex justify-content-center align-items-start flex-column">
        <h1 class="special-font big-title mb-5 ">
          محصولات خود را قسطی بفروشید ولی هزینه آن را نقد دریافت کنید!
        </h1>
        <h5 class="special-font small-title mb-5 pl-4 ">
      ...
      <div class="col-12 col-md-6 col-lg-6 d-flex justify-content-center align-items-start">
        <img src="/images/foorosh-aghsati.png" alt="افزايش فروش اقساطی با استفاده از خدمات قسطا">
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-12 col-md-6 border-top-0 border-right-0 col-lg-4 ">
        <div class="card-w-3d-icon text-center rounded p-4">
          <img src="/images/featuresIcons/afzayesh.png" alt="">
      ...
      <div class="col-12 col-md-6 border-top-0 col-lg-4 ">
        <div class="card-w-3d-icon text-center rounded p-4">
          ...
          <img src="/images/featuresIcons/risk.png" alt="">
          <h3 class="special-font">
      ...
      <div class="col-12 col-md-6 border-top-0 border-left-0 col-lg-4">
        <div class="card-w-3d-icon text-center rounded p-4">
          <img src="/images/featuresIcons/naghdinegi.png" alt="">
          <h3 class="special-font">
  ...
  <div class="container-fluid pr-0">
    <div class="row">
      <div class=" col-12 col-md-6 col-lg-6">
        <img src="/images/ghestaCart-shops.png" alt="فروش قسطي بدون ريسك بازپرداخت در فروشگاه‌هاي قسطا">
      </div>
      <div class=" col-12 col-md-6 col-lg-6 d-flex flex-column align-items-center justify-content-center">
        <div class="d-flex flex-column align-items-start justify-content-start">
          ...
          <a href="/seller/register" class="action-btn mt-1">
            <i>
              <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                <rect opacity="0.3" x="14" y="19" width="23" height="20" rx="6.42857" fill="white" />
                <path d="M7.73698 19.9653V38.2987" stroke="white" stroke-width="2.75" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path d="M36.2629 19.9653V38.2987" stroke="white" stroke-width="2.75" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path
                  d="M26.0731 38.2967V30.1494C26.0731 27.8999 24.2489 26.0757 21.9994 26.0757C19.7499 26.0757 17.9258 27.8999 17.9258 30.1494V38.2967"
                  stroke="white" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M3.6665 38.2985H40.3332" stroke="white" stroke-width="2.75" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M7.88522 19.9633C4.77222 19.9413 2.74272 16.8594 4.09205 14.2029L7.23622 8.01178C7.95305 6.60011 9.46005 5.70361 11.1137 5.70361H32.8864C34.5401 5.70361 36.0471 6.60011 36.7639 8.01178L39.9099 14.2029C41.2592 16.8594 39.2297 19.9413 36.1167 19.9633C33.5189 19.9633 31.4124 18.1886 31.4124 15.9978V15.9098C31.4124 18.1483 29.3059 19.9633 26.7081 19.9633C24.1102 19.9633 22.0037 18.1483 22.0037 15.9098C22.0037 18.1483 19.8972 19.9633 17.2994 19.9633C14.7016 19.9633 12.5951 18.1483 12.5951 15.9098V15.9978C12.5896 18.1886 10.4831 19.9633 7.88522 19.9633Z"
                  stroke="white" stroke-width="2.75" stroke-linecap="round" stroke-linejoin="round" />
