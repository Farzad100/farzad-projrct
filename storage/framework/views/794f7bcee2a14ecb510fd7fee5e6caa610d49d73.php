        ...
        <div class="tab-pane fade show active" id="users-faq" role="tabpanel" aria-labelledby="users-faq-tab">
          ...
          <div class="qa-card">
            <h5 class="special-font m-0 cursor-pointer" data-bs-toggle="collapse"
              data-bs-target="#qa-o-<?php echo e($loop->index); ?>"  aria-expanded="false"
            ...
            <p class=" m-0 mt-2 collapse" id="qa-o-<?php echo e($loop->index); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\ghesta\ghesta-git\q3til2\resources\views/pages/faq.blade.php ENDPATH**/ ?>