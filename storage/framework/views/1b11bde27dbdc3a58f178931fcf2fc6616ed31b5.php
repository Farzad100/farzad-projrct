...
<?php ($title='قسطا | خرید اقساطی گوشی از تمام ایران در کمتر از 5 روز'); ?>
<?php ($description='خرید اقساطی گوشی سامسونگ، اپل، شیائومی و هواوی از سراسر ایران. خرید گوشی قسطی در کمتر از 5 روز، بدون
نیاز به ضامن و به صورت آنلاین.'); ?>
...
<link rel="canonical"
  href="https://ghesta.ir/%D8%AE%D8%B1%DB%8C%D8%AF_%D8%A7%D9%82%D8%B3%D8%A7%D8%B7%DB%8C_%DA%AF%D9%88%D8%B4%DB%8C" />
...
<!-- features -->
<?php echo $__env->make('components.features', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\ghesta\ghesta-git\q3til2\resources\views/landings/mobile.blade.php ENDPATH**/ ?>