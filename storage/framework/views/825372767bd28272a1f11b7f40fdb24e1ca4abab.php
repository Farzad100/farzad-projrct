...
<head>
  <?php if($dev == 0): ?>
  <?php if(isset($tag_alt) && $tag_alt): ?>
  <?php echo $__env->make('addons.googletag_script_landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php else: ?>
  ...
  <link rel="stylesheet" href="/css/style.css?ver=<?php echo e($version); ?>">
</head>

<body>
  <?php if($dev == 0): ?>
  <?php if(isset($tag_alt) && $tag_alt): ?>
  <?php echo $__env->make('addons.googletag_noscript_landing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php else: ?>
  ...
  <?php if($dev == 0): ?>
  <?php echo $__env->make('addons.append_body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
  <?php endif; ?>
</body>

</html>
<?php /**PATH G:\ghesta\ghesta-git\q3til2\resources\views/layouts/app.blade.php ENDPATH**/ ?>