...
<!-- <header class="gradient-light">
  <div class="container">
    <img style="max-height: 240px" class="d-block mx-auto my-4 d-lg-none" src="/images/landings/header/<?php echo e($data['img']); ?>-sm.png" alt="عکس محصول">
    ...
    <div class="col-12 col-lg-5 mr-auto text-center text-lg-right">
      ...
      <h3 class="desc">
        با قسطا کارت بدون ضامن و در کمتر از ۵ روز انواع <?php echo e($data['type']); ?> رو قسطی بخرید
      </h3>
  ...
  <img class="d-none d-lg-block" src="/images/landings/header/<?php echo e($data['img']); ?>.png" alt="عکس محصول">
      ...
      <div class="col-12 col-md-5 col-lg-5 d-flex justify-content-center align-items-center flex-column p-0">
        <div class="info d-flex justify-content-center align-items-start flex-column ">
          ...
          <a href="/register" class="action-btn">
            <i><img src="/images/ad-ico.svg" alt=""></i>
            دریافت قسطاکارت
          </a>
...
<div class="container ads-about mt-4 pt-5">
  ...
  <div class="row flex-md-row-reverse pt-5">
    <div class="col-12 col-md-5 col-lg-5 text-center">
      <img src="/images/gc.png" alt="قسطا کارت">
    </div>
...
<!-- CTA -->
<?php echo $__env->make('components.cta', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\ghesta\ghesta-git\q3til2\resources\views/landings/laptop.blade.php ENDPATH**/ ?>